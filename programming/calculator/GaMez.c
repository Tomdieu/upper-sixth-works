...
/*printf("%c\t",127);printf("%c\t",196);
printf("%c\t",145);printf("%c",150);*/
SetConsoleTitle("Ivan snake 1.0");
    ...
    /*for(i=0;i<=50;i++)
    {
    	gotoxy(i,0);SetColor(11);printf("%c",205);
	}gotoxy(50,0);SetColor(11);printf("%c",187);
	for(i=0;i<=30;i++)
	{
		gotoxy(50,i);SetColor(11);printf("%c",186);
	}
	for(i=50;i<=0;i--)
	{
		gotoxy(i,30);SetColor(11);printf("%c",205);
	}
	*/
	lives=4;
    do
	...
	gotoxy(51,06);SetColor(11);printf("|FOOD COORDINATES X:%d  Y:%d",movex,movey);gotoxy(87,5);printf("|");
	...
	{	
		do
		{
			gotoxy(51,02);SetColor(11);printf("|Lives  : ");
			gotoxy(51,10);SetColor(12);printf("Game Over");
			gotoxy(51,11);SetColor(12);printf("press ENTER to restart");
			gotoxy(51,12);SetColor(12);printf("press ESCAPE to exit");
			b=getch();
			if(b==ENTER)
			{
				score=0;
